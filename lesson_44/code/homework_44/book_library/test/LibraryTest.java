package homework_44.book_library.test;
...
class LibraryTest {
    ...
    void findByAuthorTest(){
        Book foundByAutorBook = library.findByAuthor("Oruell");
        assertEquals( books[0], library.findByAuthor("Oruell")); // find existed book
        assertNull(library.findByAuthor("A5")); // find absent book
    }
